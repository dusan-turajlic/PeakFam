...
export default function FoodItem() {
    ...
    if (!foodItem) {
        return (
            <div className="h-[80vh] flex flex-col items-center justify-center gap-4 p-6">
                ...
                <button
                    onClick={handleBack}
                    className="px-4 py-2 bg-surface-elevated hover:bg-brand-gold hover:text-surface-base rounded-lg text-white transition-colors"
                >
                    Go Back
                </button>
            </div>
    ...
    return (
        <div className="h-screen overflow-y-auto text-white">
            {/* Header */}
            <div className="sticky top-0 bg-surface-base/80 backdrop-blur-sm z-10 flex items-center px-4 py-4 border-b border-surface-elevated">
                <button
                    onClick={handleBack}
